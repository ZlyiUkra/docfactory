...
def cache_path() -> pathlib.Path:
    """Файл кешу — в index/ примірника, а не в out/.

    Тека out/ означає «службове, у git не потрапляє»: там журнал викликів і
    рішення про спосіб пошуку. Кеш же буває потрібен саме в git — у примірника,
    чий корпус винесено в архів, це єдине, з чого збирається індекс, і клон без
    нього непрацездатний. Тому він лежить окремо, а кожен примірник сам вирішує
    рядком у своєму .gitignore, возити його з собою чи ні.
    """
    return instance.root() / "index" / "passages.json"
