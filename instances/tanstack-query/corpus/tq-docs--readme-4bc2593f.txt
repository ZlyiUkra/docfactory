# ⚛️ React Query 🐧
# джерело: https://github.com/TanStack/query/blob/v0.0.16/README.md
# отримано: 2026-09-26
# версія: 0.0.16, 0.0.15
...
A big thanks to Draqula for inspiring a lot of React Query's API and documentation. You rock!

## Demos

- A contrived CodeSandbox example
