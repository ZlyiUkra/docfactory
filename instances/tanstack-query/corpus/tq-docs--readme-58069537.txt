# README
# джерело: https://github.com/TanStack/query/blob/v1.0.0-alpha.3/README.md
# отримано: 2026-09-26
# версія: 1.0.0-alpha.3, 1.0.0-alpha.2, 1.0.0-alpha.1
...
The options for `prefetchQuery` are exactly the same as those of `useQuery`, with the exception of a `force` option:
...
- `config: Object`
  ...
  - For a description of all config options, please see their usage in both the `useQuery` hook and the `useMutation` hook.
