# README
# джерело: https://github.com/TanStack/query/blob/v0.3.7/README.md
# отримано: 2026-09-26
# версія: 0.3.7, 0.3.6, 0.3.5, 0.3.4, 0.3.3
...
- `config: Object`
  ...
  - For a description of all config options, please see the `useQuery` hook.
